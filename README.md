...
PC 온라인 서비스에 맞게 `Platform` 필드를 다음처럼 변경해보자.
...
이런 식으로 외부 랩파일에서 정의된 베이스나 이벤트를 그대로 가져다 쓰거나, 일부 필드만 교체/확장해서 활용할 수 있다.
...
> 외부 랩 파일을 이용할 때 어떤 타입과 베이스가 사용되는지 파악하면, 그 외부 랩 파일의 철학에 맞게 활용할 수 있다.
