...
def test_domain():
    data = {"domain": {"name": "bcom", "desc": "위대한 회사"}}
...
def test_types():
    data1 = {
        "domain": {"name": "bcom", "desc": "위대한 회사"},
        "types": {"Id": {"type": "integer", "desc": "Id 타입", "minimum": 0}},
    }
    types = _build_types(data1)
    assert {"Id": [["", {"type": "integer", "desc": "Id 타입", "minimum": 0}]]} == types

    data2 = {
        "domain": {"name": "acme", "desc": "위대한 게임 회사"},
        "_imported_": [data1],
    }
    types = _build_types(data2)
    assert {
        "Id": [["bcom", {"type": "integer", "desc": "Id 타입", "minimum": 0}]]
    } == types

    data3 = {
        "domain": {"name": "foo", "desc": "위대한 게임"},
        "_imported_": [data2],
    }
    types = _build_types(data3)
    assert {
        "Id": [["acme.bcom", {"type": "integer", "desc": "Id 타입", "minimum": 0}]]
    } == types
...
def test_mixins():
    data1 = {
        ...
        "bases": {
            "Account": {
                "desc": "계정 정보",
                "fields": [["AcntId", "integer", "계정 ID"]],
            },
            "Character": {
                "desc": "캐릭터 정보",
                "mixins": ["bases.Account"],
                "fields": [["CharId", "integer", "계정 ID"]],
            },
        },
    }
        ...
        "Account": [
            [
                "",
                {
                    "desc": "계정 정보",
                    "fields": {
                        "AcntId": [["", {"type": "integer", "desc": "계정 ID"}]]
                    },
                },
            ]
        ],
        "Character": [
            [
                "",
                {
                    ...
                    "fields": {
                        "AcntId": [["", {"type": "integer", "desc": "계정 ID"}]],
                        "CharId": [["", {"type": "integer", "desc": "계정 ID"}]],
                    },
                },
            ]
        ],
...
def test_bases():
    data1 = {
        ...
        "bases": {
            "Account": {
                "desc": "BCOM 계정 정보",
                "fields": [["BcomAcntId", "types.Id", "BCOM 계정 ID"]],
            },
        },
    }
    ...
    data2 = {
        ...
        "bases": {
            "Account": {
                ...
                "fields": [["AcmeAcntId", "bcom.types.Id", "ACME 계정 ID"]],
            }
        },
    }
    ...
    data3 = {
        ...
        "bases": {
            "Character": {
                "desc": "FOO 캐릭터 정보",
                "fields": [["CharId", "acme.types.Id", "캐릭터 ID"]],
            }
        },
        "events": {
            "CharLogin": {
        ...
        "Character": [
            [
                "",
                {
                    ...
                    "fields": {
                        "CharId": [
                            ["", {"type": "integer", "desc": "캐릭터 ID", "minimum": 0}]
                        ]
                    },
                },
            ]
...
def test_events():
    data = {
        ...
        "events": {
            "Logout": {
                "desc": "계정 로그아웃",
                "mixins": ["bases.Account"],
                "fields": [["PlayTime", "number", "플레이 시간 (초)", True]],
            }
        },
    }
        ...
        "Logout": [
            [
                "",
                {
                    "desc": "계정 로그아웃",
                    "fields": {
                        "DateTime": [["", {"type": "datetime", "desc": "이벤트 일시"}]],
                        "AcntId": [
                            ["", {"type": "integer", "desc": "계정 ID", "minimum": 0}]
                        ],
                        "PlayTime": [
                            [
                                "",
    ...
    data2 = {
        ...
        "events": {
            "AcntLogin": {"desc": "ACME 계정 로그인", "mixins": ["bases.Account"]}
        },
    }
    _data2 = copy.deepcopy(data2)
...
def test_desc():
    acme = {
        "domain": {"name": "acme", "desc": "최고의 게임 회사"},
        "events": {"Login": {}},
    }
    boo = {
        "domain": {"name": "boo", "desc": "최고의 PC 온라인 게임"},
        "import": [acme],
        "events": {
            "Login": {
    ...
    boo = {
        ...
        "bases": {
            ...
            "Account": {
                "desc": "계정 정보",
                "fields": [["AcntId", "integer", "계정 번호"]],
            },
        },
        "events": {
            "Login": {"mixins": ["acme.events.Login", "bases.Server", "bases.Account"]}
        },
    }
    _handle_import(boo)
    boo = build_model(boo)
...
def test_multi_imp():
    ...
    payme = {
        "domain": {"name": "payme", "desc": "최고의 결제 회사"},
        "events": {"Charge": {"desc": "PAYME 충전"}},
    }
    boo = {
        "domain": {"name": "boo", "desc": "최고의 PC 온라인 게임"},
        "import": [acme, payme],
