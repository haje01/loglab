...
class TestSchemaConfig:
    ...
    def test_default_values(self):
        ...
        assert (
            config.json_schema_version == "https://json-schema.org/draft/2020-12/schema"
        )
...
class TestPropertyBuilder:
    ...
    def test_extract_required_fields(self):
        ...
        fields = {
            ...
            "field2": [
                ["", {"type": "integer", "desc": "선택적 필드", "option": True}]
            ],
            "field3": [
                ["", {"type": "string", "desc": "또 다른 필수 필드", "option": False}]
            ],
        }
...
class TestSchemaValidator:
    ...
    def test_verify_labfile_success(self):
        ...
        self.mock_json_validator.validate.return_value = ValidationResult(
            success=True, data={"domain": {"name": "test"}}
        )
        ...
        mock_domain.events = {
            "Login": [
                [
                    ...
                    {
                        "fields": {
                            "user_id": [["", {"type": "integer", "desc": "사용자 ID"}]]
                        }
                    },
                ]
            ]
...
class TestLogFileValidator:
    ...
    def test_create_event_schemas(self):
        """이벤트별 스키마 생성 테스트."""
        schema_data = {
            "items": {"oneOf": [{"$ref": "#/$defs/Login"}, {"$ref": "#/$defs/Logout"}]},
            "$defs": {"Login": {"type": "object"}, "Logout": {"type": "object"}},
        }
